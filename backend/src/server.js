...
const app = createApp({
  ...
  gencatImagesEnabled: config.gencatImagesEnabled,
  gencatImageCachePath: config.gencatImageCachePath,
  gencatImageCacheTtlHours: config.gencatImageCacheTtlHours,
  gencatImageCacheMaxMb: config.gencatImageCacheMaxMb,
  gencatImageRequestTimeoutMs: config.gencatImageRequestTimeoutMs,
  gencatImageMaximumBytes: config.gencatImageMaximumBytes,
