...
// This deliberately has no I/O of its own.  Keeping the analysis synchronous
// lets an authorized writer inspect the exact transaction-local topology
// without opening another connection or yielding its SQLite write lock.
export function auditDibaQuality(db, { databasePath, municipalityReferences, generatedAt = new Date().toISOString() } = {}) {
