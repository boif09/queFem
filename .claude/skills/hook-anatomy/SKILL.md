---
name: hook-anatomy
description: Use when analyzing, evaluating, or generating hooks for short-form video or text posts.
---
...
Hooks work differently by platform. Load the relevant `references/platforms/{platform}.md` from this skill's own directory. (Local copy: only `instagram.md` and `tiktok.md` are included.)
