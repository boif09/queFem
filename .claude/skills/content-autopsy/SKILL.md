...
For platform-specific metric interpretation, load `references/platforms/{platform}.md` from this skill's own directory. (Local copy: only `instagram.md` and `tiktok.md` are included.)
